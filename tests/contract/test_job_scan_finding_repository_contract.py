...
# postgres_jobs.py's own methods), so PostgresJobRepositoryContractTests
...
# applies, in the same order. Without it, SET LOCAL ROLE fails with
# "role \"worker_tenant_data\" does not exist" the first time any test
# here calls one of those three methods.
