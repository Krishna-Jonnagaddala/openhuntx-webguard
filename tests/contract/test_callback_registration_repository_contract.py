...
# P1-2 Phase H: register and get_registration now run under
# worker_tenant_data (see postgres_callback_service.py's own class
# docstring), so this test needs the same role/ACL/function/runtime-
# grant bootstrap tests/contract/test_identity_repository_contract.py's
